...
C Read the table
      ...
      If (order .EQ. 1) then
        ...
        Write(filenimi,'(A,A,I1)'), trim(root),"EPS09LOR_",A
        Else If (A < 100) Then
        !Write(filenimi,'("EPS09LOR_", I2)'), A
        Write(filenimi,'(A,A,I2)'), trim(root),"EPS09LOR_",A
        Else If (A < 1000) Then
        !Write(filenimi,'("EPS09LOR_", I3)'), A
        Write(filenimi,'(A,A,I3)'), trim(root),"EPS09LOR_",A
        End If
      ...
      Else
        ...
        Write(filenimi,'(A,A,I1)'), trim(root),"EPS09NLOR_",A
        Else If (A < 100) Then
        !Write(filenimi,'("EPS09NLOR_", I2)'), A
        Write(filenimi,'(A,A,I2)'), trim(root),"EPS09NLOR_",A
        Else If (A < 1000) Then
        !Write(filenimi,'("EPS09NLOR_", I3)'), A
        Write(filenimi,'(A,A,I3)'), trim(root),"EPS09NLOR_",A
        End If
